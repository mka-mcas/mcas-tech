  ...
  if (!post) {
    return (
      <div className="min-h-screen bg-[#070b12] text-slate-400 flex flex-col items-center justify-center p-6 text-center">
        <p className="font-mono text-sm uppercase mb-4 text-amber-500">
          404 • Article Profile Not Found
        </p>
        <Link
          href="/blog"
          className="text-xs font-bold uppercase text-sky-400 tracking-wider hover:underline"
        >
    ...
    <article className="min-h-screen bg-[#070b12] text-slate-300 pt-32 pb-24 px-6">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="mb-10">
          <Link
            href="/blog"
            className="text-xs font-bold tracking-wider uppercase text-sky-400 hover:text-sky-300 transition-colors flex items-center gap-2"
          >
        ...
        <header className="mb-12">
          <div className="flex flex-wrap items-center gap-2 text-xs font-mono text-sky-500 mb-3">
            <span>
              Published on{" "}
        ...
        <div className="prose prose-invert max-w-none text-slate-300 font-light text-base md:text-lg space-y-6 leading-relaxed">
          <ReactMarkdown
            ...
            components={{
              ...
              div: ({ ...props }) => (
                <span
                  className="block overflow-x-auto my-6 py-2 text-center text-white"
                  {...props}
                />
              ),
            }}
