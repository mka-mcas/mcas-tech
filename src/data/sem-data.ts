...
export const constructs: Construct[] = [
  {
    ...
    r2: 0.503,
    indicators: [
      { id: "Letih_RLR", label: "Riding / lane-related fatigue indicator", loading: 0.420, p: "<.001" },
      { id: "Letih_bwk_laju", label: "High-speed riding fatigue indicator", loading: 0.516, p: "<.001" },
      { id: "Letih_ubah_tbt", label: "Frequent lane-change indicator", loading: 0.508, p: "<.001" },
      { id: "Crash_hist", label: "Crash history", loading: 0.172, p: ".003" },
    ],
  ...
  },
  {
    ...
    r2: 0.745,
    indicators: [
      { id: "CFS_4", label: "CFS item 4", loading: 0.754, p: "<.001" },
      { id: "CFS_5", label: "CFS item 5", loading: 0.880, p: "<.001" },
      { id: "CFS_6", label: "CFS item 6", loading: 0.854, p: "<.001" },
      { id: "CFS_7", label: "CFS item 7", loading: 0.900, p: "<.001" },
    ],
  ...
  },
  {
    ...
    short: "Keletihan mental",
    r2: 0.273,
    indicators: [
      { id: "CFS_8", label: "CFS item 8", loading: 0.841, p: "<.001" },
      { id: "CFS_9", label: "CFS item 9", loading: 0.803, p: "<.001" },
      { id: "CFS_10", label: "CFS item 10", loading: 0.771, p: "<.001" },
      { id: "CFS_11", label: "CFS item 11", loading: 0.587, p: "<.001" },
    ],
  ...
  },
  {
    ...
    short: "Keletihan fizikal",
    r2: 0.254,
    indicators: [
      { id: "CFS_1", label: "CFS item 1", loading: 0.820, p: "<.001" },
      { id: "CFS_2", label: "CFS item 2", loading: 0.632, p: "<.001" },
      { id: "CFS_3", label: "CFS item 3", loading: 0.838, p: "<.001" },
    ],
  ...
  },
  {
    ...
    short: "Prolonged fatigue",
    r2: 0.974,
    indicators: [
      { id: "P_sleepy", label: "Ever rode while sleepy", loading: 0.815, p: "<.001" },
      { id: "P_napped", label: "Ever rode after falling asleep / dozing", loading: 0.394, p: "<.001" },
      { id: "P_month", label: "Fatigued in the past month", loading: 0.814, p: "<.001" },
    ],
  ...
  {
    id: "motivation",
    label: "Motivation (Dorongan)",
    short: "Dorongan",
    r2: 1.0,
    indicators: [
      { id: "Tj_mng", label: "Riding purpose grouping", loading: 0.514, p: ".724" },
      { id: "Umur", label: "Age range", loading: 0.426, p: ".762" },
      { id: "Crash_hist_m", label: "Crash history", loading: -0.293, p: "<.001" },
    ],
