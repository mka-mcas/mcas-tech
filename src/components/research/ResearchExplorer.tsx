  ...
  return <div className="space-y-5">
    ...
    <div className="grid gap-5 xl:grid-cols-[430px_1fr]">
      <Card className="p-5"><div className="flex items-center gap-2 text-amber-600 dark:text-amber-300"><SlidersHorizontal size={16}/><h3 className="font-semibold text-slate-900 dark:text-white">Build an intervention scenario</h3></div><p className="mt-2 text-[11px] leading-5 text-slate-500">These are scenario levers, not measured effect sizes.</p>
        <div className="mt-5 space-y-5">
          ...
          <div className="border-t border-slate-200 pt-5 dark:border-slate-800"><div className="mb-3 text-[9px] font-mono uppercase tracking-[.18em] text-slate-500">Scale & economics</div><div className="grid gap-3 sm:grid-cols-2">
            ...
            <label><span className="text-[10px] text-slate-600 dark:text-slate-400">Baseline events / year</span><input type="number" min="0" value={baselineEvents} onChange={e=>setBaselineEvents(Math.max(0,Number(e.target.value)||0))} className="mt-1 w-full rounded-lg border border-slate-300 bg-white px-3 py-2 text-xs text-slate-900 dark:border-slate-700 dark:bg-slate-950 dark:text-white"/></label>
      ...
      <Card className="p-5"><div className="grid gap-4 md:grid-cols-2">
        <div className="rounded-2xl border border-slate-200 bg-slate-50 p-5 dark:border-slate-800 dark:bg-slate-950/50"><div className="text-[10px] font-mono uppercase text-slate-500">Observed safety profile</div><div className="mt-3 text-4xl font-mono font-semibold text-slate-900 dark:text-white">23.2%</div><div className="mt-1 text-xs text-slate-500">Reported total SA mean, Experiment 2</div></div>
        <div className="rounded-2xl border border-amber-200 bg-amber-50 p-5 dark:border-amber-500/20 dark:bg-amber-500/5"><div className="text-[10px] font-mono uppercase text-amber-700 dark:text-amber-300">Scenario safety profile</div><div className="mt-3 text-4xl font-mono font-semibold text-slate-900 dark:text-white">{result ? result.sa.toFixed(1)+"%" : "—"}</div><div className="mt-1 text-xs text-slate-600">Synthetic SA-like indicator under selected assumptions</div></div>
      </div>
